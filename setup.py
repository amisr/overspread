...
if os.environ.get('READTHEDOCS', None) == 'True':
    ...
    # SPECTRAL WORKER EXTENSION
    spec_sources = ['src/spec_worker/spec_worker.c']
    spec_ext = Extension(name = 'overspread._c_spec_worker',
...
if __name__ == "__main__":
    ...
    setup(
        ...
        description='Production E and F region lag product fitting software for AMISRs.',
        ...
        keywords='radar incoherent-scatter ionosphere thomson amisr',
        ...
        package_data={'overspread': ['dat/*','radars.ini'],
                     },
