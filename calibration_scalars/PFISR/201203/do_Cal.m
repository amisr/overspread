...
try
acx=load('cal-201203-filelist_ac.txt_2.27_5.44-09.19.2012.mat'); acx=acx.x;
...
try
acx=load('cal-201201-filelist_lp.txt_1.51_5.81-09.07.2012.mat'); acx=acx.x;
acCal=acx(1)*cos(thbs*pi/180.0+acx(3)).^acx(2);
plot(thbs,acCal,'b')
catch
end
...
try
acx=load('cal-201202-filelist_lp.txt_2.18_8.43-09.17.2012.mat'); acx=acx.x;
acCal=acx(1)*cos(thbs*pi/180.0+acx(3)).^acx(2);
plot(thbs,acCal,'m')
catch
end
