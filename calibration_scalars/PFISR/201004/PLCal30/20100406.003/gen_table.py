...
if __name__ == '__main__':
    ...
    #
    dat = sio.loadmat('cal-201004-filelist_lp.txt_0.68_6.83-01.22.2013.mat')
    x = dat['x'][0]
    ...
    if read_from_file == True:
        ...
        # From raw file
        fname = '/Volumes/AMISR_012/Data AMISR Poker/20100406.001/d0196498.dt0.h5'
        ...
        try:
            BeamcodeMap = output['BeamCodes']
        except:
            BeamcodeMap = output['/Setup']['BeamcodeMap']
