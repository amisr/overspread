...
ksysbco=[64016,64112,64124,64157,64982,65162]; %ksysbco=[64037, 64157];
ksystab=[1.55162,1.418512,1.304566,1.211912,1.7326,1.67369]; %ksystab=[1.451, 1.084];
...
for aa=1:length(FILES)
    ...
    fprintf('beam: %d, %2.2f,%2.2f,%2.2f\n',TLINE1(1),az*180/pi,el*180/pi,alphBS(aa));
...
acCal=1.9245*cos(thbs*pi/180.0).^2.3991;
plot(thbs,acCal,'g')
...
print(gcf,'-dpng',[exp '-' char(fname(1)) '_' num2str(x(1),'%2.2f') '_' num2str(x(2),'%2.2f') '-' date '.png']);