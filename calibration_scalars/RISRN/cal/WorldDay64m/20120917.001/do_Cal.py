...
if __name__ == '__main__':
    ...
    BM = numpy.loadtxt('WorldDay64-201206-calibration-ksys-11.01.2012.txt')
    ...
    tbs_array = scipy.zeros(len(ksystab))
    ...
    #initial guess
    [a,b],flag = leastsq(residual,[0,0],args=(ksystab,tbs_array))
    oldksys = a*thbs+b
    ...
    #initial guess
    [a,b],flag = leastsq(residual,[0,0],args=(y,num))
    ...
    #load AC
    try:
        dat = sio.loadmat('cal-201209-filelist_ac.txt_-0.01_1.77-12.14.2012.mat')
        acx = dat['x'][0]
        acCal = acx[0]*thbs+acx[1]
