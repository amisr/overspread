...
C 2000.03 07/11/01 variables EGNR, AGNR,OGNR not used (P. Wilkinson)
c 2000.04 10/28/02 replace TAB/6 blanks, enforce 72/line (D. Simpson)
C 2000.05 11/08/02 change unit for coefficients to 14
C 2000.06 06/05/03 correct DIPL computation (V. Truhlik)
C
