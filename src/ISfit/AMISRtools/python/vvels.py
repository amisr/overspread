...
# compute_velvec2
def compute_velvec2(PLAT,AllVlos,AlldVlos,Allk,AllPlat,AllPlong,Allht,htmin=150.0*1000,htmax=400.0*1000,covar=[1000.*1000.,1000.*1000.,5.*5.],p=[200.0,0.5,2000.0,100.0],MAX_VALS=200):
    # 
    # This function takes the line of sight velocities and resolves them into vector velocities as a function of magnetic latitude.  
