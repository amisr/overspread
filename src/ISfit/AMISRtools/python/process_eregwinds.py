...
def eregwinds():
	...
	"""
	"""
	fname_ac='/Volumes/AMISR_004/processed_data/2008/MSWinds21/20080906.002/20080906.002_ac_15min.h5'
	fname_lp='/Volumes/AMISR_004/processed_data/2008/MSWinds21/20080906.002/20080906.002_lp_15min.h5'
	oname='/Volumes/AMISR_004/processed_data/2008/MSWinds21/20080906.002/derivedParams/nuin1.0/20080906.002-winds_lp15min_ac15min.h5'
	"""

	fname_ac='/Volumes/AMISR_004/processed_data/2007/IPY04/20071201.001.done/IPY04-20071201.001_ac_15min-cal.h5'
	fname_lp='/Volumes/AMISR_004/processed_data/2007/IPY04/20071201.001.done/IPY04-20071201.001_lp_15min-cal.h5'
	oname='/Volumes/AMISR_004/processed_data/2007/IPY04/20071201.001.done/derivedParams/nuin1.0/IPY04-20071201.001-winds_lp15min_ac15min.h5'
	"""
...
#			Iht2=scipy.where(tht>=tm1[-1]+tm1[1]-tm1[0])[0]
			...
			# velocity vector
			(alt_out1,tVest,tdVest,tdVestAll,xx)=vvels.compute_velvec2(htout,AllVlos,AlldVlos,Allk,Allht,[],Allht,htmin=0.0,htmax=1000.0*1000,covar=[3000.*3000.,3000.*3000.,30.*30.],p=[200.0,0.5,2000.0,100.0])
