...
if __name__ == '__main__':
	...
	"""
	DISK_PATH='/Volumes/AMISR_009/' # volume where data is
	FILE_PATH=os.path.join(DISK_PATH,'Data AMISR Poker')  # where the experiments are
	DIR_WC='200904*' # wild card to select expss from
	OUTFILE='/Volumes/AMISR_004/ExperimentLists/ExpList_Amisr009_'+DIR_WC[:-1]+'.csv'
