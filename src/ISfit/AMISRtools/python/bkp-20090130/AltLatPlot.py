...
#	ddir='/Users/mnicolls/Documents/Work/ISfit/AMISR_fitter_py/runfiles/Sporadic03/20071018.001/'
	ddir='/Volumes/AMISR_004/processed_data/WorldDay02/20070428.001/'
	fname='20070428.001_ac_2min-rng2.h5'; ofname='20070428.001'
	odir='plots_ac_2min-AltLat'
	saveout=1
...
#	LatLims=scipy.array([65.0,70.0])
	...
	geoang=scipy.arcsin(kpn[:,0]/scipy.sqrt(scipy.power(kpn[:,0],2.0)+scipy.power(kpe[:,0],2.0)))*180.0/scipy.pi	
	geoang=geoang.real
	Ibm=scipy.where(geoang>2.0)[0]
	...
	for ibm in range(Nbeams):
		GeomagAlt[ibm,:]=proc_utils.range2height(GeomagRange[ibm,:],BeamCodes[ibm,2])
	Time=output['/Time']
