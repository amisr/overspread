...
#	ST=''; ILdir='/Volumes/AMISR_004/processed_data/PlCal03'
	ST=''; ILdir='/Volumes/AMISR_004/processed_data/2008/Erickson12/';
#	ST='IPY04'+ST0 + '-'; ILdir='/Volumes/AMISR_004/processed_data/2008/IPY04/';
...
def proc_pl2_IPY():
	...
	# IPY04 ***
	FILELIST_UP='/Volumes/AMISR_004/processed_data/2008/IPY05/20080502.001/IPY05-filelist_PL2-64157.txt'
	FILELIST_DN='/Volumes/AMISR_004/processed_data/2008/IPY05/20080502.001/IPY05-filelist_PL1-64157.txt'
	EXP='IPY04'
	ODIR='/Volumes/AMISR_004/processed_data/2008/IPY05/20080502.001' + '/cal-0'
	DAT_PATH = ''
	DIR_SEARCH = 1
	Is=0
	beams2do=[64157]
	...
	# Erickson 2008
	ddir='20080929.001'
	FILELIST_UP='/Volumes/AMISR_004/processed_data/2008/Erickson12/' + ddir + '/filelist_PL2.txt'
	FILELIST_DN='/Volumes/AMISR_004/processed_data/2008/Erickson12/' + ddir + '/filelist_PL1.txt'	
	EXP='Erickson02'
	ODIR='/Volumes/AMISR_004/processed_data/2008/Erickson12/' + ddir + '/cal-0'
	...
	"""
	ddir='20080229.001'
	FILELIST_UP='/Volumes/AMISR_004/processed_data/PlCal03/' + ddir + '/filelist_PL2.txt'
	FILELIST_DN='/Volumes/AMISR_004/processed_data/PlCal03/' + ddir + '/filelist_PL1.txt'	
	EXP='PlCal03'
	ODIR='/Volumes/AMISR_004/processed_data/PlCal03/' + ddir + '/cal-0'
	DAT_PATH = '/Volumes/AMISR_006/Data AMISR Poker/' + ddir
	DIR_SEARCH = 1
	Is=0
	beams2do=[]	
	MAXFILES=5
...
#				return tmp
				...
				pylab.subplot(211)
				pylab.imshow(scipy.signal.medfilt2d(pl_up+10.0*pl_dn, kernel_size=KS),vmin=1e7,vmax=1e8,aspect='auto',origin='lower',extent=[freq_up[0],freq_up[-1],time_up[0],time_up[-1]])	
				pylab.colorbar()
				ax1=pylab.gca()
...
#				clim=[1e8,1e8]
				...
				while not_ok:
					...
					if info=='':
						...
						pylab.subplot(211)
						pylab.imshow(scipy.signal.medfilt2d(pl_up+10.0*pl_dn, kernel_size=KS),vmin=1e7,vmax=clim[0],aspect='auto',origin='lower',extent=[freq_up[0],freq_up[-1],time_up[0],time_up[-1]])	
						ax1=pylab.gca()
						ax1.set_ylabel('Time (secs)')
						ax1.set_xlabel('Freq (Hz)')
						pylab.title('%d (%2.2f,%2.2f) - %2.2f km' % (bmcode[0],bmcode[1],bmcode[2],alt_pl[Ialt]/1000.0))
