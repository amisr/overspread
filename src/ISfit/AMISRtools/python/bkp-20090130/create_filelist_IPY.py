...
if __name__ == '__main__':
	...
	FITTER_PATH='/Volumes/AMISR_004/processed_data/2007/'
	DIR_WC='200703*' # wild card to select exps from
	...
	if MODE=='IPY05':
		if CODE=='LP':
			# Long pulse setup
			IPY_COMPAT_MODES=[MODE,'IPY15','PLCal03','Erickson02','WorldDayTEC05','LTCS01','Mathews01','Lyons03'];	
			IPY_FILES_WC=['*.dt3.h5','*.dt3.h5','*.dt3.h5','*.dt3.h5','*.dt3.h5','*.dt3.h5','*.dt3.h5','*.dt3.h5']; 
			OUTFILE=os.path.join(FITTER_PATH,MODE+'/'+MODE+'-filelist_LP.txt')
		elif CODE=='AC':
			# Alt code setup
			IPY_COMPAT_MODES=[MODE,'IPY15','PLCal03','Erickson02','WorldDayTEC05','LTCS01','Mathews01','Lyons03'];	
			IPY_FILES_WC=['*.dt0.h5','*.dt0.h5','*.dt0.h5','*.dt0.h5','*.dt0.h5','*.dt0.h5','*.dt0.h5','*.dt0.h5']; 
