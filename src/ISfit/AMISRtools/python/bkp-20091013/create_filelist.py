...
if __name__ == '__main__':
	...
	DIR_WC='200903*' # wild card to select exps from
...
#	NAME='IPY04'; MODE=['IPY04']; CODE='AC'; WC='*.dt0.h5'; 
	NAME='IPY15'; MODE=['IPY05','IPY15','IPY16']; CODE='LP'; WC='*.dt3.h5'; 
#	NAME='IPY15'; MODE=['IPY05','IPY15','IPY16']; CODE='AC'; WC='*.dt0.h5'; 
	OUTDIR=os.path.join('/Volumes/AMISR_004/processed_data/2009',NAME)
