C     $Id: milmag.f,v 1.4 2005/09/01 15:29:37 brideout Exp $
C
...
C     .. Local Scalars ..
      ...
      DOUBLE PRECISION R,T,F,RBR,RBT,RBP
      INTEGER IYEAR
C     ..
...
C     convert glon to radians
      GLON = GLON/57.2958    
      
C     Call method igrf_geo - all arguments are Double Precision
      IYEAR=ANINT(TM)
      R=RKM/6371.2
      T=GCLAT
      F=GLON
      CALL TS_RECALC(IYEAR,1,1,1,1)
      CALL IGRF_GEO(R,T,F,RBR,RBT,RBP)
