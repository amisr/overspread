...
C     .. Scalar Arguments ..
      ...
      INTEGER IY,NM
C     ..
C     Modified by Bill Rideout to simply call Geopack_2005 IGRF_GEO
C     .. External Subroutines ..
      EXTERNAL IGRF_GSM, TS_RECALC
      call TS_RECALC(IY,180,0,0,0)
...
C  SUBROUTINE GIVES A WARNING (BUT DOES NOT REPEAT IT AT THE NEXT CALLS)
      IF (IY.NE.IYR .AND. IPR.EQ.0) PRINT 9000,IYR,IY
      IF (IY.NE.IYR) IPR = 1
      IYE = IY
